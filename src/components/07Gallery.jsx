...
export default function Gallery({ textFromInput, onSecretRoomChange, ...gameProps }) {
  return (
    <div className="w-full h-full bg-violet-500 flex items-center justify-center p-8">
      <div className="w-full h-full flex flex-col items-center justify-center">
        ...
        <Nook textFromInput={textFromInput} onSecretRoomChange={onSecretRoomChange} {...gameProps} />
      </div>
    </div>
  );
}
