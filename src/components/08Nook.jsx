...
export default function Nook({ textFromInput, onSecretRoomChange, ...gameProps }) {
  return (
    <div className="w-full h-full bg-purple-500 flex items-center justify-center p-8">
      <div className="w-full h-full flex flex-col items-center justify-center">
        ...
        <SecretRoom textFromInput={textFromInput} onSecretRoomChange={onSecretRoomChange} {...gameProps} />
      </div>
    </div>
  );
}
